        ...
        <div>
            <nav className="w-full bg-slate-400 py-3 px-4 text-inherit flex flex-wrap justify-between items-center">
                ...
                <ul className="hidden md:flex md:space-x-8 text-sm">
                    <li><Link href="/" className="hover:text-red-500 opacity-5">Home</Link></li>
                    <li><Link href="" className="hover:text-red-500">Page</Link></li>
                    <li><Link href="" className="hover:text-red-500">Product</Link></li>
                    <li><Link href="" className="hover:text-red-500">Blog</Link></li>
                    <li><Link href="" className="hover:text-red-500">Shop</Link></li>
